...
function OpportunityRow({ opportunity, index, maxValue, app, canOpenLinks, }) {
    ...
    return (_jsxs("div", { onClick: handleClick, style: {
            ...
            e.currentTarget.style.boxShadow = "none";
                ...
                }, title: oppName, children: oppName }), _jsx("div", { style: {
                    flex: 1,
                    height: "22px",
                    background: "#f3f4f6",
                    borderRadius: "4px",
                ...
                }, children: formatCurrency(value) }), isClickable && (_jsx("img", { src: dataverseIcon, alt: "Open in Dynamics 365", title: "Open in Dynamics 365", style: {
                    width: "16px",
                    height: "16px",
                    borderRadius: "4px",
                    ...
                    overflow: "hidden",
                            ...
                            overflow: "hidden",
                                    ...
                                    justifyContent: "space-between",
                                                ...
                                                }, children: "Top Opportunities" }), _jsx("p", { style: {
                                                    margin: "0.15rem 0 0",
                                                    fontSize: "0.75rem",
                                                    color: "rgba(255,255,255,0.7)",
                                                    fontWeight: 500,
                                                }, children: "Ranked by estimated value" })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: "0.6rem" }, children: [_jsx("div", { style: {
                                                ...
                                                }, children: ranked.length }), _jsx("img", { src: dataverseIcon, alt: "Dataverse", style: {
                                                    width: "24px",
                                                    height: "24px",
                                                    borderRadius: "6px",
                                                    background: "rgba(255,255,255,0.25)",
                                                    padding: "4px",
                                                } })] })] })] }), _jsx("div", { style: { padding: "0.6rem 0.75rem 0.4rem" }, children: ranked.length === 0 ? (_jsx("div", { style: {
                                textAlign: "center",
                                padding: "2rem 1rem",
                                color: "#9ca3af",
                                fontSize: "0.9rem",
                                fontWeight: 500,
                            }, children: "No opportunity data to display" })) : (ranked.map((opp, i) => (_jsx(OpportunityRow, { opportunity: opp, index: i, maxValue: maxValue, app: app, canOpenLinks: canOpenLinks }, opp.id ?? i)))) }), ranked.length > 0 && (_jsxs("div", { style: {
                        ...
                        }, children: ["Showing top ", ranked.length, " of ", totalWithValue, " \u00B7 ", "Total: ", _jsx("strong", { style: { color: TEAL }, children: formatCurrency(totalValue) })] }))] })] }));
}
