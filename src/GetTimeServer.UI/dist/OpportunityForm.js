...
export function OpportunityForm() {
    ...
    const displayData = { ...oppData, ...editedFields };
            ...
            boxSizing: "border-box",
                    ...
                    overflow: "hidden",
                            ...
                            overflow: "hidden",
                                    ...
                                    animation: "shimmer 8s ease-in-out infinite",
                                } }), _jsxs("div", { style: { position: "relative", display: "flex", alignItems: "flex-start", justifyContent: "space-between" }, children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("h2", { style: {
                                                    margin: 0,
                                                    fontSize: "1.15rem",
                                                    fontWeight: 800,
                                                    color: "#ffffff",
                                                ...
                                                }, children: oppName }), _jsxs("div", { style: {
                                                    display: "flex",
                                                    alignItems: "center",
                                                    gap: "0.4rem",
                                                    marginTop: "0.3rem",
                                                            ...
                                                            fontWeight: 600,
                                                        }, children: displayData.statecode || "Open" }), displayData.customerid && (_jsxs(_Fragment, { children: [_jsx("span", { style: { color: "rgba(255,255,255,0.4)", fontSize: "0.7rem" }, children: "|" }), _jsx("span", { style: {
                                                                    fontSize: "0.78rem",
                                                                    ...
                                                                    overflow: "hidden",
                                                                    textOverflow: "ellipsis",
                                                                }, children: displayData.customerid })] }))] })] }), _jsx("img", { src: dataverseIcon, alt: "Dataverse", title: canOpenLinks ? "Open in Dynamics 365" : undefined, onClick: canOpenLinks && oppData ? () => app?.openLink({ url: `${DYNAMICS_BASE}${oppData.id}` }) : undefined, style: {
                                            width: "24px",
                                            height: "24px",
                                            borderRadius: "6px",
                                        ...
                                        } })] })] }), _jsxs("div", { style: { padding: "1rem 1.5rem 1.4rem" }, children: [_jsx("div", { style: {
                                    display: "flex",
                                    flexDirection: "column",
                                    gap: "0.75rem",
                                }, children: OPPORTUNITY_FIELDS.map(({ key, label, icon, editable }, i) => {
                                    ...
                                    return (_jsxs("div", { style: {
                                            animation: `field-in 0.4s cubic-bezier(0.16, 1, 0.3, 1) ${0.3 + i * 0.08}s both`,
                                                ...
                                                }, children: [_jsx(FieldIcon, { d: icon }), label] }), _jsx("input", { type: "text", value: editedFields[key] ?? oppData[key] ?? "", onChange: (e) => handleFieldChange(key, e.target.value), readOnly: !editable, style: {
                                                    width: "100%",
